...
#include "ns3/tcp-yeah-my.h"
#include "ns3/test.h"

using namespace ns3;

NS_LOG_COMPONENT_DEFINE("TcpYeahMyTestSuite");

/**
 * \ingroup internet-test
 *
 * \brief Testing TcpYeahMy additive increase algorithm.
 */
class TcpYeahMyIncrementTest : public TestCase
{
  public:
    /**
     * \brief Constructor.
     ...
     */
    TcpYeahMyIncrementTest(uint32_t cWnd,
                         uint32_t ssThresh,
  ...
  private:
     ...
     */
    void IncreaseWindow(Ptr<TcpYeahMy> cong);
...
TcpYeahMyIncrementTest::TcpYeahMyIncrementTest(uint32_t cWnd,
                                           uint32_t ssThresh,
                                           uint32_t segmentSize,
                                           SequenceNumber32 nextTxSeq,
                                           SequenceNumber32 lastAckedSeq,
...
TcpYeahMyIncrementTest::DoRun()
{
    ...
    Ptr<TcpYeahMy> cong = CreateObject<TcpYeahMy>();
...
void
TcpYeahMyIncrementTest::IncreaseWindow(Ptr<TcpYeahMy> cong)
{
 ...
 * \ingroup internet-test
 *
 * \brief Testing TcpYeahMy multiplicative decrease algorithm
 */
class TcpYeahMyDecrementTest : public TestCase
{
  public:
    /**
     * \brief Constructor.
     ...
     * \param name Test description.
     */
    TcpYeahMyDecrementTest(uint32_t cWnd,
                         uint32_t ssThresh,
                         uint32_t segmentSize,
                         SequenceNumber32 nextTxSeq,
                         SequenceNumber32 lastAckedSeq,
  ...
  private:
     ...
     */
    uint32_t CalculateSsThresh(Ptr<TcpYeahMy> cong);
...
TcpYeahMyDecrementTest::TcpYeahMyDecrementTest(uint32_t cWnd,
                                           uint32_t ssThresh,
                                           uint32_t segmentSize,
                                           SequenceNumber32 nextTxSeq,
                                           SequenceNumber32 lastAckedSeq,
...
uint32_t
TcpYeahMyDecrementTest::CalculateSsThresh(Ptr<TcpYeahMy> cong)
{
    // Calculate queue backlog
    uint32_t segCwnd = m_cWnd / m_segmentSize;
    uint32_t reduction;
 ...
 */
class TcpYeahMyTestSuite : public TestSuite
{
  public:
    TcpYeahMyTestSuite()
        : TestSuite("tcp-yeah-my-test", Type::UNIT)
    {
        AddTestCase(new TcpYeahMyIncrementTest(20 * 1446,
                                             25 * 1446,
                                             1446,
        ...
        AddTestCase(new TcpYeahMyIncrementTest(30 * 1446,
                                             25 * 1446,
                                             1446,
                                             SequenceNumber32(2893),
                                             SequenceNumber32(1447),
                    ...
                    TestCase::Duration::QUICK);
        AddTestCase(new TcpYeahMyIncrementTest(
                        40 * 356,
                        30 * 356,
                        356,
        ...
        AddTestCase(new TcpYeahMyIncrementTest(
                    ...
                    TestCase::Duration::QUICK);
        AddTestCase(new TcpYeahMyDecrementTest(
                        40 * 1446,
                        30 * 1446,
                        1446,
                        SequenceNumber32(2893),
...
static TcpYeahMyTestSuite g_tcpYeahMyTest; //!< Static variable for test initialization
